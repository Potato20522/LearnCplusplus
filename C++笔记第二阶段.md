...
![image-20210813001526953](C++笔记第二阶段.assets/image-20210813001526953.png)
...
![image-20210813002014078](C++笔记第二阶段.assets/image-20210813002014078.png)
...
void test01() {
    ...
    //第四种插入方式,不推荐，因为如果不存在key，它默认会创建一个出来
    m[4] = 40;
    printMap(m);
...
void test01() {
    ...
    long num = count(v.begin(), v.end(), 4);
...
void test02() {
    ...
    long num = count(v.begin(), v.end(), p);
    cout << "num = " << num << endl;
}
